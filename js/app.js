(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            new core(".category-products__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".category-products-button-prev",
                    nextEl: ".category-products-button-next"
                },
                on: {}
            });
            new core(".galery-delivery-map__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4.3,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".delivery-map-button-prev",
                    nextEl: ".delivery-map-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
            ...
            const miniSlider = new core(".map-product__prev .map-product-mini__slider", {
                freeMode: true,
                slidesPerView: 4,
                spaceBetween: 6,
                breakpoints: {
            ...
            new core(".map-product__image .map-product__slider", {
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 0,
            ...
            new core(".body-slider__slider_1", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 18,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".body-slider__prev_1",
                    nextEl: ".body-slider__next_1"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.28
            ...
            new core(".body-slider__slider_2", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 18,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".body-slider__prev_2",
                    nextEl: ".body-slider__next_2"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.28
            ...
            new core(".body-slider__slider_recommend", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 18,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".body-slider__prev_recommend",
                    nextEl: ".body-slider__next_recommend"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.28
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("search-menu__icon")) document.querySelector(".search-menu").classList.toggle("_active"); else if (!targetElement.closest(".search-menu") && document.querySelector(".search-menu._active")) document.querySelector(".search-menu").classList.remove("_active");
        }
    };
    window["FLS"] = true;
    isWebp();
